...
export default function OAuth() {
    ...
    const navigate = useNavigate(); // Initialize navigation for routing after successful sign-in

    // Function to handle Google sign-in when button is clicked
    const handleGoogleClick = async () => {
        try {
            ...
            console.log('Could not sign in with Google', error); // Log any error that occurs during sign-in process
        }
    }

    {/* Button for signing in with Google and displaying Google logo */}
    return (
        <button
            onClick={handleGoogleClick} // Trigger Google sign-in when clicked
            type='button'
